class InvaderProjectile extends GameObject
{
    constructor(x = 0, y = 0, z = 0) 
	{
        ...
        this.height = 20;
        this.image = null;
        loadImage("Images/invader_projectile.png", (img) => {
            const scale = 2;
            this.image = img;
    ...
    update(dt)
    {
        if(this.isInitialized && this.isActive)
        {
            ...
            if(collisionRectCollision(this, m_SpaceShip))
            {
                if(m_SpaceShip.isActive)
					{
                        this.isActive = false;
			            m_SpaceShip.hitByShot();
					}
            }
